...
/**
 * ViewWaybillDetailsId generated by hbm2java
 */
public class ViewWaybillDetailsId implements java.io.Serializable {
	...
	public ViewWaybillDetailsId() {
	}

	public ViewWaybillDetailsId(Serializable bar, int branchId, Serializable measure, Serializable name, int numParty,
			Double priceWithSale, Double priceС, Double procSale, int productId, Double qty, int rowId, Double sumSale,
			Integer tax, Double totalPrice, Double totalPriceCur, int wayBid) {
		this.bar = bar;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof ViewWaybillDetailsId))
			return false;
		ViewWaybillDetailsId castOther = (ViewWaybillDetailsId) other;
		...
		return ((this.getBar() == castOther.getBar())
				...
				&& ((this.getQty() == castOther.getQty()) || (this.getQty() != null
						&& castOther.getQty() != null && this.getQty().equals(castOther.getQty())))
